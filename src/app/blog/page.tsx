        ...
        <div className="flex flex-col justify-center items-center px-12 py-32" id="projetos">
            <div className="grid grid-cols-2 gap-96 justify-between items-center">
                <div className="flex flex-col">
                    <p className="text-base"><span aria-hidden="true" className="text-[#FFA0D4] mx-2">→</span>Publicações</p>
                    <h1 className="text-5xl font-semibold">Insights <span className="text-[#FFA0D4] font-normal pencerio">recentes</span></h1>
                </div>
