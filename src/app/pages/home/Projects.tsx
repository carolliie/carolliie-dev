...
export default function Projects() {
  ...
  return (
    <div
      className={`px-12 pb-24 lg:px-24 lg:pb-32 mx-auto flex flex-col ${
        isVisible ? "fade-in-effect" : ""
      }`}
      id="projetos"
      ref={ref}
    >
      <div className="flex flex-row justify-between items-center">
        <div className="flex flex-col">
          <p className="text-sm lg:text-base">
            <span aria-hidden="true" className="text-[#FFA0D4] mx-2">
              →
            </span>
            Meu portfólio
          </p>
          <h1 className="text-4xl lg:text-5xl font-semibold flex flex-col">
            Projetos{" "}
            <span className="text-[#FFA0D4] font-normal text-base">
              recentes
            </span>
          </h1>
        </div>
