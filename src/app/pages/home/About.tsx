...
export default function About() {
    return (
        <div className="flex flex-col lg:flex-row py-16 px-6 lg:py-32 lg:px-12 justify-center items-center bg-[url('/sobre-background.svg')] bg-cover bg-center bg-no-repeat" id="sobre">
            <div className="flex flex-col lg:w-1/2 gap-y-8 justify-center mx-8 lg:mx-0">
