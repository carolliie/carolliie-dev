    ...
    return (
        <div className="flex container mx-auto flex-col lg:flex-row justify-between relative px-12 pb-20 lg:px-24 lg:pb-32" id="faq">
            <div className="flex flex-col gap-y-4 mb-10 lg:mb-0 sticky top-0 w-fit lg:w-[450px]">
                ...
                <a href="https://www.linkedin.com/in/ana-caroline-vieira-526374274/" className="bg-[#F2FFAB] text-black font-medium flex flex-row justify-between items-center gap-x-6 py-3 px-4 w-1/2 rounded-lg">
                    Ver linkedin
