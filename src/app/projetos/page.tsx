import AllProjectsSection from "../pages/common/AllProjects";
import ProjectsSection from "../pages/common/ProjectsSection";

export default function ProjectsPage() {
    return (
        <div className="flex flex-col justify-center items-center px-12 py-32" id="projetos">
            <div className="grid grid-cols-2 gap-96 justify-between items-center">
                <div className="flex flex-col">
                    <p className="text-base"><span aria-hidden="true" className="text-[#FFA0D4] mx-2">→</span>Meu portfólio</p>
                    <h1 className="text-5xl font-semibold">Projetos <span className="text-[#FFA0D4] font-normal pencerio">recentes</span></h1>
                </div>

                <a href="https://github.com/carolliie" className="flex flex-row justify-between items-center gap-x-4 bg-white text-black font-medium py-1.5 px-3 rounded-full w-36">Ver mais
